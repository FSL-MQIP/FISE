...
# set constant temperature (Note: Rachel, ask Sarah if want to sample from temperature distribution of consumer refrigerators, we did this for the Buffalo MC model)
data$temp <- 6
```

iii. Apply intervention and add results from sampling distribution in (i) to dataframe
```{r}
