...
n_sim <- 10 #can use any n_sim for testing code, but need to change to at least 10k when running experiments
...
df_temp2 <- data[c(1,2,5:8)]

# now merge 
data2 <- merge(df_temp,df_temp2,by=c("lot_id","milk_unit"))
