...
author: "Rachel Evanowski and Sarah Murphy; edited from an existing file written by Mike Phillips"
date: "4/13/20"
output: pdf_document
---
...
This version of the model incorporates a temperature distribution rather than assuming a static temperature. Specifically, the temperature is drawn from a La Place distribution with mean of XXX and a standard deviation of XXX.
...
To simulate the results of the intervention, we apply a 0.22 log reduction to this distribution and sample using a mean of -0.943 (?). Each model was run for 10,000 iterations. 
